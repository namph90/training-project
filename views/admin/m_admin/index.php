...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <table class="table table-bordered table-hover thead-light" style="text-align: center;">
            <tr>
                <th style="width: 50px;">Id <a href="index.php?controller=admin&action=index&order=idAsc"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
                <th style="width: 100px;">Avatar</th>
                <th style="width:150px;">Name <a href="index.php?controller=admin&action=index&order=nameAsc"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
                <th style="width: 100px;">Email <a href="index.php?controller=admin&action=index&order=emailAsc"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
                <th style="width: 80px;">Role <a href="index.php?controller=admin&action=index&order=roleAsc"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?php if(file_exists("assets/upload/admin/".$rows->id."/".$rows->avatar)): ?>
                            <img src="assets/upload/admin/<?php echo $rows->id; ?>/<?php echo $rows->avatar; ?>" style="width: 70px;">
                        <?php endif; ?>
                    </td>
